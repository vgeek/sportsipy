...
BOXSCORE_ELEMENT_INDEX = {
    ...
    'location': 1,
    'home_record': -1,
    'home_minutes_played': 0,
    'home_field_goals': 0,
    'home_field_goal_attempts': 0,
    'home_field_goal_percentage': 0,
    'home_two_point_field_goals': 0,
    'home_two_point_field_goal_attempts': 0,
    'home_two_point_field_goal_percentage': 0,
    'home_three_point_field_goals': 0,
    'home_three_point_field_goal_attempts': 0,
    'home_three_point_field_goal_percentage': 0,
    'home_free_throws': 0,
    'home_free_throw_attempts': 0,
    'home_free_throw_percentage': 0,
