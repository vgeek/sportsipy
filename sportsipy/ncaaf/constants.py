...
BOXSCORE_SCHEME = {
    ...
    'home_name': '.linescore > tbody:nth-child(2) > tr:nth-child(2) > td:nth-child(2) > a:nth-child(1)',
    # 'away_name': 'a[itemprop="name"]:last',
    'away_name': '.linescore > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(2) > a:nth-child(1)',
